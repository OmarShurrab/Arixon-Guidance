          ...
          {filteredReviews.map((q) => {
            ...
            return (
              ...
              >
                ...
                {/* Explanation Box */}
                {q.explanation && (
                  <div className="p-4 rounded-2xl bg-blue-50/70 dark:bg-blue-950/40 border border-blue-200/60 dark:border-blue-900/50 space-y-1.5">
                    <div className="flex items-center gap-1.5 text-xs font-bold text-blue-800 dark:text-blue-300">
                      <Lightbulb className="w-4 h-4 text-amber-500 flex-shrink-0" />
                      <span>التعليل والشرح الفيزيائي النموذجي:</span>
                    </div>
