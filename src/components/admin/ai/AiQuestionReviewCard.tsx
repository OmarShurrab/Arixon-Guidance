...
export const AiQuestionReviewCard: React.FC<AiQuestionReviewCardProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Explanation Preview */}
      {draft.explanation && (
        <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200/60 dark:border-slate-800/60 text-xs text-slate-600 dark:text-slate-300 mb-4">
          <span className="font-bold text-slate-900 dark:text-white block mb-1">
            شرح وتبرير الإجابة النموذجية:
          </span>
